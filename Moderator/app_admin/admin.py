...
from app_admin.models import YearbookUser, Role
...
# admin.site.register(YearbookModerator, YearbookUserAdmin)
# admin.site.register(YearbookPlayer, YearbookUserAdmin)
admin.site.register(Role, YearbookUserAdmin)
# admin.site.register(ModerationTicket, YearbookUserAdmin)